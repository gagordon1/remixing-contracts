...
contract CoolCats is Sidechain, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI, address _parent, uint256 _REP )
    Sidechain(_parent, _REP) ERC721("Cool Cats", "COOL")  {
        setBaseURI(baseURI);
